        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '<a href="/Pages/Profile/User" class="text-heading text-truncate"><span class="fw-medium">' +
              $name +
              '</span></a>' +
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="/Apps/Invoice/Preview" data-bs-toggle="tooltip" class="btn btn-icon" data-bs-placement="top" title="Preview Invoice"><i class="bx bx-show bx-md"></i></a>' +
              '<div class="dropdown">' +
