...
function showDeleteConfirmation(userId) {
  ...
  Swal.fire({
    ...
    html: `<p>Are you sure you want to delete user ?<br> <span class="fw-medium text-danger">${userName}</span></p>`,
    icon: 'warning',
  ...
  $('#userTable').DataTable({
    ...
    buttons: [
      ...
      },
      {
        ...
        text: '<i class="bx bx-plus me-0 me-sm-1_5"></i><span class="d-none d-sm-inline-block">Add New User</span>',
